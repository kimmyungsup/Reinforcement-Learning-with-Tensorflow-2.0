...
class ActorCriticTrain:
    ...
    def critic_loss(self, states, next_states, rewards, dones):
        last_state = states[-1]
        if dones[-1] == True :
            reward_sum = 0
        else :
    ...
    def train(self, states, actions, rewards, next_states, dones):
        ...
        with tf.GradientTape() as tape_critic:
            ...
            critic_loss = self.critic_loss(states, next_states, rewards, dones)
        ...
        with tf.GradientTape() as tape:
            ...
            actor_loss = self.actor_loss(states, actions, values, rewards, next_values, dones)
